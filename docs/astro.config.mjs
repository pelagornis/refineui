          ...
          items: [
            { label: 'Overview', translations: { ko: '개요' }, slug: 'foundations' },
            {
              ...
              items: [
                ...
                { label: 'Spacing', translations: { ko: '스페이싱' }, slug: 'foundations/spacing' },
                { label: 'Sizing', translations: { ko: '사이징' }, slug: 'foundations/sizing' },
                { label: 'Radius', translations: { ko: '라디우스' }, slug: 'foundations/radius' },
                { label: 'Border', translations: { ko: '보더' }, slug: 'foundations/border' },
                { label: 'Elevation', translations: { ko: '엘리베이션' }, slug: 'foundations/elevation' },
