...
| **2. Documentation routing** | Start from `llm.txt` / `llms.txt`, open leaf pages on ui.pelagornis.com; use MCP when available |
...
| Layer | Role |
|-------|------|
| **Doc routing** | Start from `llm.txt` / `llms.txt`, open leaf pages on ui.pelagornis.com |
...
1. Read `https://ui.pelagornis.com/llms.txt` or `https://ui.pelagornis.com/llm.txt`
