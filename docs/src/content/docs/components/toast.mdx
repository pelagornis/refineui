...
Swipe or drag the toast toward an edge (based on `position`) to dismiss it early.
...
<div class="not-content">
  <PropSpec
    ...
    { prop: "position", default: "\"top-center\"", type: "\"top-left\" | \"top-center\" | \"top-right\" | \"bottom-left\" | \"bottom-center\" | \"bottom-right\"", description: "Toast position." },
    { prop: "swipeDirections", default: "from position", type: "(\"top\" | \"right\" | \"bottom\" | \"left\")[]", description: "Allowed swipe-to-dismiss directions." }
    ]}
  />
</div>
