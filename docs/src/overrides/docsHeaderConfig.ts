...
const HEADER_NAV_KO: Record<string, { label: string; links?: Record<string, { label: string; description?: string }> }> = {
    foundations: {
        ...
        links: {
            ...
            Spacing: { label: "Spacing", description: "레이아웃 리듬" },
            Layout: { label: "레이아웃", description: "그리드, 컨테이너, 정렬" },
            Iconography: { label: "Iconography", description: "시스템 아이콘 저장소" },
        },
    },
    components: {
        label: "컴포넌트",
...
export const DOCS_SEARCH_ITEMS: DocsSearchItem[] = [
    ...
    { value: "collapsible", label: "Collapsible", href: "/components/collapsible/", group: "Components" },
    ...
    { value: "context-menu", label: "Context Menu", href: "/components/context-menu/", group: "Components" },
