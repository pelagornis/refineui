  ...
  return (
    <PreviewFrame>
      <div style={{ maxWidth: "300px", display: "flex", flexDirection: "column", gap: spacings.sizeLarge }}>
        <div>
          <p style={{ margin: 0, marginBottom: spacings.sizeXXSmall, fontSize: fontSizes.fontSize300 }}>Medium (default)</p>
          <Slider value={valueMd} onChange={setValueMd} min={0} max={100} size="md" />
          <p style={{ marginTop: spacings.sizeXSmall, marginBottom: 0, fontSize: fontSizes.fontSize300 }}>Value: {valueMd}</p>
        </div>
        <div>
          ...
          <p style={{ marginTop: spacings.sizeXSmall, marginBottom: 0, fontSize: fontSizes.fontSize300 }}>Value: {valueSm}</p>
        </div>
      </div>
    </PreviewFrame>
  );
