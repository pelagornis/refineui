...
- **[Foundations](/foundations/)** — Visual language, design tokens, layout, and iconography
...
- **[AI Integration](/ai-integration/)** — Cursor, Claude, Copilot via `llm.txt`
...
- [Foundations](/foundations/) — tokens, layout, iconography
