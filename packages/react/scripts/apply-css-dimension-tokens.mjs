...
const pairs = [
    ...
    ["padding: 8px", "padding: var(--refineui-spacing-size-small)"],
    ...
    [
        "padding: 7px",
        "padding: calc(var(--refineui-spacing-size-small) - var(--refineui-stroke-width-thin))",
    ],
    [
    ...
    ["outline-offset: 2px", "outline-offset: var(--refineui-spacing-size-xxx-small)"],
    ["text-underline-offset: 2px", "text-underline-offset: var(--refineui-spacing-size-xxx-small)"],
    ...
    ["margin-top: -6px", "margin-top: calc(-1 * var(--refineui-spacing-size-x-small))"],
    [
        "margin-top: -7px",
        "margin-top: calc(-1 * (var(--refineui-spacing-size-x-small) + var(--refineui-spacing-size-minimal)))",
    ],
    [
        "transform: scale(1.15)",
        "transform: scale(var(--refineui-motion-scale-hover-grow))",
    ],
];
