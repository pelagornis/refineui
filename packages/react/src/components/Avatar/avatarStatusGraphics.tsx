            ...
            return (
                <svg viewBox="0 0 14 14" className={cn} aria-hidden {...props}>
                    <g clipPath={`url(#${clipId}-online)`}>
                        <circle cx="7" cy="7" r="7" fill="var(--refineui-color-green-500)" />
                    </g>
                    <defs>
                ...
                <svg viewBox="0 0 14 14" className={cn} aria-hidden {...props}>
                    <g clipPath={`url(#${clipId}-away)`}>
                        <path
                            ...
                            fill="var(--refineui-color-yellow-300)"
                        />
                    </g>
                    <defs>
                ...
                <svg viewBox="0 0 14 14" className={cn} aria-hidden {...props}>
                    <g clipPath={`url(#${clipId}-unav)`}>
                        <path
                            ...
                            fill="var(--refineui-color-red-500)"
                        />
                        <path
                            ...
                            fill="var(--refineui-color-neutral-white)"
                        />
                    </g>
                    <defs>
            ...
            return (
                <svg viewBox="0 0 14 14" className={cn} aria-hidden {...props}>
                    <g clipPath={`url(#${clipId}-off)`}>
                        <circle cx="7" cy="7" r="7" fill="var(--refineui-color-neutral-300)" />
                    </g>
                    <defs>
