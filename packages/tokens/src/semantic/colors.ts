...
export const SEMANTIC_PALETTE_PAIRS = {
    ...
    backgroundSuccessSubtle: { light: "green100", dark: "neutral800" },
    ...
    backgroundWarningSubtle: { light: "yellow100", dark: "neutral800" },
